...
def scrape_from_urls(starting_idx = 0, save_file_path=os.path.join(DATA_FOLDER, 'book_data.tsv'), save_mode='w'):
    ...
    with(open(os.path.join(DATA_FOLDER, 'book_urls.txt'), 'r')) as f:
        urls = f.readlines()
...
if __name__ == "__main__":
    ...
    scrape_from_urls(starting_idx=start_url_idx, save_mode=save_mode)